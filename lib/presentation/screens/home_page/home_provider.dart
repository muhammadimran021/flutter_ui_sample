...
class HomeProvider extends ChangeNotifier {
  ...
  _setUpRemoteConfigs() async {
    if (_remoteConfig == null || _remoteConfig.settings == null) {
  ...
  Future<void> fetchAndActivate() async {
    ...
    if (_remoteConfig.lastFetchStatus == RemoteConfigFetchStatus.noFetchYet ||
        _remoteConfig.lastFetchStatus == RemoteConfigFetchStatus.failure) {
